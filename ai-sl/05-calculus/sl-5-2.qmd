...
$f'(x)$ の式が分かっているなら、`nSolve` で解けます。`nSolve` は `menu → Algebra → Numerical Solve` から入れられます（[SL 1.8](../01-number-and-algebra/sl-1-8.qmd#nsolve)）。

$\texttt{nSolve}\left(3x^{2} - 12x = 0,\ x\right)$
