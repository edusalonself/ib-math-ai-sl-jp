...
$\texttt{nSolve}\left(\dfrac{\sin(x)}{9} = \dfrac{\sin(105)}{14},\ x,\ 0,\ 90\right) \ \to \ 38.3857\ldots$
...
$\texttt{nSolve}\left(9^{2} = 5^{2} + 7^{2} - 2 \times 5 \times 7 \times \cos(x),\ x,\ 0,\ 180\right) \ \to \ 95.7391\ldots$

辺を求めるときも同じです。$\sqrt{\ }$ の付け忘れも起きません。

$\texttt{nSolve}\left(x^{2} = 7^{2} + 10^{2} - 2 \times 7 \times 10 \times \cos(55),\ x,\ 0,\ 100\right) \ \to \ 8.28850\ldots$
...
- $8 \times \dfrac{\sin(63)}{\sin(42)} \ \to \ 10.6527\ldots$
- $\sqrt{7^{2} + 10^{2} - 2 \times 7 \times 10 \times \cos(55)} \ \to \ 8.28850\ldots$
- $\cos^{-1}\left(\dfrac{5^{2} + 7^{2} - 9^{2}}{2 \times 5 \times 7}\right) \ \to \ 95.7391\ldots$

**cosine rule は、$\sqrt{\ }$ ごとまとめて入れてしまう**と、$\sqrt{\ }$ の付け忘れも防げます。

### 4. 出た角を、そのまま次に使う

- $\cos^{-1}\left(\dfrac{1.5}{4.2}\right)$ を出す  →  `ctrl` + `var`  →  `th` に記憶
- $4.2 \times \sin(\texttt{th}) \ \to \ 3.92300\ldots$
...
$\texttt{nSolve}\left(\dfrac{x}{\sin(63)} = \dfrac{8}{\sin(42)},\ x,\ 0,\ 100\right) \ \to \ 10.6527\ldots$
...
$\texttt{nSolve}\left(0.5 \times 9 \times 14 \times \sin(x) = 50,\ x,\ 0,\ 90\right) \ \to \ 52.528\ldots$
...
$\texttt{nSolve}\left(0.5 \times 9 \times 14 \times \sin(x) = 50,\ x\right)$ でも出ます。
:::
