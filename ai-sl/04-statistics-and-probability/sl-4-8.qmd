...
$\texttt{binomPdf}\left(12,\ 0.25,\ 3\right)$
...
$\texttt{binomPdf}\left(20,\ 0.08,\ 2\right)$
...
$\texttt{binomCdf}\left(20,\ 0.08,\ 0,\ 2\right)$
...
$\texttt{binomCdf}\left(20,\ 0.08,\ 3,\ 20\right)$
...
$\texttt{binomPdf}\left(15,\ 0.7,\ 12\right)$
...
$\texttt{binomCdf}\left(15,\ 0.7,\ 10,\ 13\right)$
...
$\texttt{binomPdf}\left(5,\ 0.3,\ 2\right)$
...
シラバスは、確率を `technology` で求めるよう指定しています。**つまり GDC を使って求めます。****ここの操作を覚えれば、この項目の計算はすべて出せます。**
...
$\texttt{binomCdf}\left(25,\ 0.6,\ 12,\ 18\right)$
...
$\texttt{binomCdf}\left(8,\ 0.45,\ 5,\ 8\right)$
