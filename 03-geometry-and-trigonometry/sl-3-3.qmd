...
さらに、**図そのものに点が付くことがあります。** 答案用紙に消さずに残しておいてください。

「頭の中でやる」と、**どの角がどの辺の向かいなのかを必ず取り違えます。**
:::
...
| **1** | **北**（North）から測る |
| **2** | **時計回り**に測る |
| **3** | **必ず3桁**で書く（$060^\circ$ であって $60^\circ$ ではない） |

: bearing の3つの約束 {#tbl-sl33-bearing}

::: {.callout-warning}
## $3$ 桁で書かないと、点になりません ★★
$8^\circ$ 東寄りの北なら **$008^\circ$** です。$8^\circ$ とは書きません。

真西は **$270^\circ$**、南東は **$135^\circ$** です。

**$0$ を先頭に足すだけ**ですが、これを忘れて落とす人がとても多いところです。
:::
...
| もとの方位角 | やること | 例 |
|---|---|---|
| $180^\circ$ より**小さい** | $+180^\circ$ | $073^\circ \to 253^\circ$ |
| $180^\circ$ より**大きい** | $-180^\circ$ | $215^\circ \to 035^\circ$ |

: back bearing の出し方 {#tbl-sl33-back}

**答えが $0^\circ$ から $360^\circ$ のあいだに収まるほう**を選ぶ、と覚えると迷いません。
...
**確かめ。** 近づいたので、見下ろす角は**大きくなる**はずです。$24^\circ \to 31.7^\circ$ ✓
...
**まず図をかいて、$P$ と $Q$ に North の線を入れます**（@fig-sl33-journey）。
...
**答案の図に点が付くこともあるので、消さずに残しておいてください。**
...
::: {.callout-tip collapse="true"}
## 解説
**$180^\circ$ より小さければ足し、大きければ引きます**（@tbl-sl33-back）。
