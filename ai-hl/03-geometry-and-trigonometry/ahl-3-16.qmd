...
vertex が多いと、degree を数えまちがえます。リストにして足してください。`sum(` は `catalog` から選べます（[AHL 3.14](ahl-3-14.qmd#gdc-sum)）。

$\texttt{sum}\left(\{3,\ 3,\ 4,\ 4,\ 2\}\right)$
...
$\texttt{sum}\left(\{4,\ 6,\ 8,\ 3,\ 7,\ 5,\ 9,\ 2\}\right)$
