...
vertex が多いときは、degree をリストに入れて `sum()` で足すと、数え落としが見つけやすくなります。`sum(` は `catalog` から選べます（[SL 1.2](../../ai-sl/01-number-and-algebra/sl-1-2.qmd) と同じ関数です）。

$\texttt{sum}\left(\{2,\ 3,\ 4,\ 3,\ 2\}\right)$
