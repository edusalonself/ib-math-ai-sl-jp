...
$\texttt{poissPdf}\left(3.4,\ 2\right)$
...
$\texttt{poissCdf}\left(3.4,\ 0,\ 2\right)$
...
$\texttt{poissCdf}\left(3.4,\ 4,\ 1\texttt{E99}\right)$

（`normCdf` の端には記号パレットの $\infty$ を入れられます。この本の normal の項目では $\infty$ で書いています——[SL 4.9](../../ai-sl/04-statistics-and-probability/sl-4-9.qmd#infinity)。ここは Poisson なので、大きな数のまま書いています。）
