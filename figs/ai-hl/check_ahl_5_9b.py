...
# ══════════════════════════════════════════════════════════
#  2026-08: quotient rule の過剰な一般化をやめた
# ══════════════════════════════════════════════════════════
in_text("**まず、約分や簡単な式変形ができないかを確かめてください。** できなければ quotient rule を使います。")
in_text("分母が $x^{2}+1$ や $e^{x}+1$ のような**和になっている**ときは、**ふつうは quotient rule が必要**です。")
not_in_text("**書き直しで済むのは、$x$ のべき乗どうしの分数だけ**です。")
not_in_text("**書き直せないので quotient rule だけ**です。")
in_text("1. **分数の形か** → はい なら、まず約分や式変形ができないかを見る。できなければ quotient rule（[第4節](#avoid)）")
not_in_text("1. **分数の形か** → はい なら quotient rule（ただし分子も分母も $x$ のべき乗だけなら")
