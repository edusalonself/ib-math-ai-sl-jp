...
::: {.callout-important}
## 自分でかくときは、なめらかな曲線でつなぎます ★★
**@fig-sl42-cum は、点と点のあいだが直線になっています。** 読み取った値（$Q_1 = 20$、median $\approx 28$、$Q_3 = 38$）と目盛りをぴったり合わせるために、この本ではそうしています。

**ですが、答案では違います。** cumulative frequency graph は、**フリーハンドのなめらかな曲線**でつなぎます。**定規は使いません。**

- ✗ 点と点を定規で結んで、折れ線にする
- ◎ **点をぜんぶ通るように、なめらかな曲線を1本かく**

だから、この曲線を **cumulative frequency curve** とも呼びます。
